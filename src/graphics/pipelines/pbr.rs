...
use crate::{
    ...
    graphics::{
        ...
        resources::{GPUResourceManager}, mesh::MeshVertexData
    }
};
...
pub fn create(resources: &Resources) {
    ...
    pbr_desc.layouts = vec!["locals".to_string(), "globals".to_string(), "pbr_material_layout".to_string(), "probe_material_layout".to_string()];
    pbr_desc.cull_mode = wgpu::CullMode::Back;
    let vertex_size = std::mem::size_of::<MeshVertexData>();
    pbr_desc.vertex_state

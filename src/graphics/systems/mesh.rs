use crate::{
    graphics::{
        pipelines::GlobalUniform, render_graph::RenderGraphNode, resources::GPUResourceManager,
        CommandBufferQueue, CommandQueueItem, RenderGraph,
    },
    scene::components::{
        CameraData, DirectionalLightData, Material, Mesh, PointLightData, Transform,
    },
};
use legion::prelude::*;
use std::sync::Arc;
